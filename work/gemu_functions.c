...
void
push32(Emulator *emu, uint32_t value)
{
...
void
update_eflags_sub(Emulator *emu, uint32_t v1, uint32_t v2, uint64_t result)
{
    int sign1 = v1 >> 31;
    int sign2 = v2 >> 31;
...
void
set_carry(Emulator *emu, int is_carry)
{
    if(is_carry) {
...
void
set_zero(Emulator *emu, int is_zero)
{
    if(is_zero) {
...
void
set_sign(Emulator *emu, int is_sign)
{
    if(is_sign) {
